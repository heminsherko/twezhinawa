...
export default function SourceFinder() {
  ...
  return (
    <div id="source-finder" className="w-full scroll-mt-32">
      <div className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-slate-700 shadow-xl rounded-3xl p-6 md:p-10 w-full transition-colors duration-300">
        
        {/* Header Section */}
        <div className="flex flex-col items-center text-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-[#00A8CC]/10 flex items-center justify-center mb-4">
            <Search className="w-8 h-8 text-[#00A8CC]" />
          </div>
          <h2 
        ...
        >
          ...
          <motion.a 
            ...
            className="group relative flex flex-col p-6 bg-[#F4F7F6] dark:bg-[#020617] border border-[#E2E8F0] dark:border-slate-700 rounded-2xl hover:-translate-y-2 hover:border-[#00A8CC] hover:shadow-lg transition-all duration-300"
          >
            <div className="absolute top-6 right-6">
              <ExternalLink className="w-5 h-5 text-slate-400 group-hover:text-[#00A8CC] transition-colors duration-300" />
            </div>
          ...
          >
            ...
            <h3 dir="ltr" className="text-xl font-bold text-[#0A2540] dark:text-white mb-3 text-right">
              English Sources
            </h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed flex-1">
