          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <a href="https://t.me/+9647732640262" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-all group">
