...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ckb" dir="rtl" className={rudaw.variable} suppressHydrationWarning>
      <body className="font-sans antialiased bg-[#F4F7F6] dark:bg-[#020617] text-[#0A2540] dark:text-slate-100 transition-colors duration-300 flex flex-col min-h-screen">
        <Navbar />
