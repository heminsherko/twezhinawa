            ...
            <motion.div key="step4" {...fadeAnim} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {/* Telegram */}
                  <a href="https://t.me/heminsherko" target="_blank" rel="noreferrer" className="bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-md border border-slate-200 dark:border-slate-700 p-6 rounded-2xl flex flex-col items-center gap-3 hover:-translate-y-2 hover:border-[#0088cc] hover:shadow-[0_10px_20px_-10px_rgba(0,136,204,0.4)] transition-all shadow-sm">
